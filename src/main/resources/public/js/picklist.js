(function ($) {
    ...
    $.fn.pickList = function (options) {
        ...
        this.controll = function () {
            ...
            $("#pAdd").on('click', function (event) {
                var p = pickThis.find("#pickData");
                var s = p.find("option");
                //var ss = s.find("selected");
                //ss.clone().appendTo("#pickListResult");

                $( s ).filter(function( index, value ) {
        ...
        this.getValues = function () {
            ...
            this.find("#pickListResult option").each(function () {
                objResult.push({id: this.id, name: this.name});
            });
            return objResult;
        };
        this.init = function () {
